...
{
        $arCaptcha = array("default" => GetMessage("F_CAPTCHA_BITRIX"),
            "recaptcha" => GetMessage("F_CAPTCHA_GOOGLE"),
            "recaptchav3" => "reCAPTCHA v3 Google"); // ToDo: Lang
        ...
        elseif($arCurrentValues["CAPTCHA_TYPE"]=="recaptchav3"){
            $arReCThemes = array("dark" => GetMessage("RECAPTCHA_THEME_DARK"), "light" => GetMessage("RECAPTCHA_THEME_LIGHT"));
            $arComponentParameters["PARAMETERS"]["RECAPTCHA_THEME"] = array(
                "PARENT" => "SPAM",
                "NAME" => GetMessage("F_RECAPTCHA_THEME"),
            ...
            $arComponentParameters["PARAMETERS"]["RECAPTCHA_VALID_SCORE"] = array(
                "PARENT" => "SPAM",
                "NAME" => GetMessage("F_RECAPTCHA_VALID_SCORE"),
                "TYPE" => "STRING",
                "ADDITIONAL_VALUES" => "N",
                "MULTIPLE" => "N",
                "DEFAULT" => 0.5,
...
$arComponentParameters["PARAMETERS"]["JQUERY_EN"] = array(
        ...
        "MULTIPLE" => "N",
        "REFRESH" => "N",
        "VALUES" => array("jquery2" => GetMessage("FB_ADD_JQUERY_JQUERY2"), "jquery3" => GetMessage("FB_ADD_JQUERY_JQUERY3"), "N" => GetMessage("FB_ADD_JQUERY_NO")),
        "DEFAULT" => "jquery3",
);
