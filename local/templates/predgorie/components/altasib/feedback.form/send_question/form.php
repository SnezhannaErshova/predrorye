        ...
        foreach ($arResult["FIELDS"] as $key => $arField):?>
            ...
            <div id="afbf_<?= mb_strtolower($arField["CODE"]) ?>" class="afbf_item_pole<?= $fieldClass ?>">
                <div class="afbf_name<?= $nameClass ?>">
                    <? echo $arField["NAME"] ?> <? if ($arField["REQUIRED"]): ?><span
                            class="afbf_required_text">*</span><? endif ?>
                        ...
                        <div class="afbf_inputtext_bg">
                            ...
                            <select name="FIELDS[<?= $arField["CODE"] ?>][]" multiple="multiple">
                                ...
                                <select class="afbf_select" name="FIELDS[<?= $arField["CODE"] ?>]">
                                    <? endif; ?>
<!--                                    zdes-->
                                    <option value=""><? echo $arField["NAME"] ?></option>
                ...
                <? elseif ($arField["USER_TYPE"] == "HTML"): ?>
                    <div class="afbf_inputtext_bg" id="error_<?= $arField["CODE"] ?>">
                        ...
                        <? else: ?>
                            <textarea placeholder="<? echo $arField["NAME"] ?>" cols="" rows="" id="<?= $arField["CODE"] ?>1"
                                      name="FIELDS[<?= $arField["CODE"] ?>]"
                        ...
                        <? if (!empty($arField["LINKED_SECTIONS"])):
                            ...
                            echo($arField["PROPERTY"]["MULTIPLE"] == "Y" ? " multiple=\"multiple\"" : ""); ?>>
                                ...
                                foreach ($arField["LINKED_SECTIONS"] as $arEl):?>
                                    <option class="" value="<? echo $arEl["ID"] ?>"<?
                ...
                <? elseif ($arField["TYPE"] != "F"):
                    ?>
                    <div class="afbf_inputtext_bg form-item" id="error_<?= $arField["CODE"] ?>">
                        <? if (!empty($_POST["FIELDS"][$arField["CODE"]])): ?>
                            <input type="text" size="40" id="<?= $arField["CODE"] ?>1"
                                   name="FIELDS[<?= $arField["CODE"] ?>]"
                                   value="<?= trim(htmlspecialcharsEx($_POST["FIELDS"][$arField["CODE"]])) ?>"
...
<!--tut-->
                            <input placeholder="<? echo $arField["NAME"] ?>" type="text" size="40" id="<?= $arField["CODE"] ?>1"
                                   name="FIELDS[<?= $arField["CODE"] ?>]"
                                   <?= $readonly ?>
                                   class="afbf_inputtext form-input"/>
                        <? else: ?>
                            <input placeholder="<? echo $arField["NAME"] ?>" type="text" size="40" id="<?= $arField["CODE"] ?>1"
                                   name="FIELDS[<?= $arField["CODE"] ?>]" value="<?= $arField["DEFAULT_VALUE"] ?>"
                                   class="afbf_inputtext"
                    ...
                    <div class="afbf_inputtext_bg file">
                        ...
                        <? if ($arField["MULTIPLE"] == "Y"): ?>
                            <input type="file" id="afbf_file_input_add<?= $k ?>"
                                   ...
                                   multiple="true"/>
                        <? else: ?>
                            <input type="file" id="afbf_file_input_add<?= $k ?>" name="myFile[<?= $arField['CODE'] ?>]"
                                   class="afbf_file_input_add"/>
                        <? endif; ?>
                        <div class="afbf_input_group">
                            <input type="text" size="40" id="<?= $arField["CODE"] ?>1"
                                   name="FIELDS[myFile][<?= $arField["CODE"] ?>]" value="" class="afbf_inputtext"/>
        ...
        <div class="afbf_submit_block">
            <input type="submit" class="fb_close afbf_btn main-btn" id="fb_close_<?= $ALX ?>" name="SEND_FORM"
